...
export default function QualitySection() {
  return (
    <section className=" bg-darkCryanBlue rounded-[10px] text-center px-6 xl:px-[5.5rem] pb-[3.75rem] flex flex-col mb-[7.5rem] xl:flex-row-reverse xl:text-start xl:gap-32">
